...
exports.addNewBiodata = function (req, res) {
    ...
    // Pastikan semua field yang dibutuhkan sudah terisi
    const { nama, nim, jurusan, alamat, tanggal_lahir, nomor_telepon, email } = req.body;
    if (!nama || !nim || !jurusan || !alamat || !tanggal_lahir || !nomor_telepon || !email) {
